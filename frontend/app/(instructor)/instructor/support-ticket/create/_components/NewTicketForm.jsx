                ...
                <div className="dashboard-body-wrapper">
                    <div className="container">
                        <div className="d-flex justify-content-between mb-3">
                            <h5 >{trans('Open Ticket')}</h5>
                            <Link className="btn btn--base" href="/instructor/support-ticket">{trans('Tickets')}</Link>
                        </div>
                                            ...
                                            {({ setFieldValue }) => (
                                                <Form>
                                                    ...
                                                    <FormGroup>
                                                        ...
                                                        <Input className="form-control form--control form-select" as="select" name="priority" required={true}>

...
export default function Profile() {
    const { initialValues, validationSchema, handleSubmit, user } = useInstructorProfile();
        ...
        <div className="col-12">
            <div className="card custom--card border-0">
                <div className="card-header">
                    <h4 className="card-header__title">Profile</h4>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="edit-account__form">
                            <div className="card-body">
                                            ...
                                            <div className="course-image-upload">
                                                <div className="course-image-upload__thumb">
                                                    <Image
                                                        ...
                                                        src={previewImage || getProfileImage(user?.profile_path, user?.image)}
                                                        alt="image"
                                                    />
                                                </div>
                                ...
                                <div className="edit-account__button">
                                    <SubmitBtn isSubmitting={isSubmitting} className="btn btn--base" title={trans('Submit')} />
                                </div>
                            </div>
                        </form>
                    )}

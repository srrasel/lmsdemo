...
export default function useInstructorLoginHandler() {
    ...
    const handleSubmit = async (values, { resetForm }) => {
        ...
        const { data } = await request.post(ENDPOINTS.INSTRUCTOR_LOGIN, values);
        ...
        setCookie('instructor_data', JSON.stringify(userData));
    ...
    const logout = async () => {
        await request.get(ENDPOINTS.INSTRUCTOR_LOGOUT);
        deleteCookie("access-token");

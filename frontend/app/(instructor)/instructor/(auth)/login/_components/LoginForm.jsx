...
import useInstructorLoginHandler from "../_hooks/useInstructorLoginHandler";
...
export default function LoginForm() {
    const { initialValues, validationSchema, handleSubmit } = useInstructorLoginHandler();
                ...
                <div className="container">
                    <div className="account-form">
                        ...
                        <div className="account-form__content">
                            <h4 className="account-form__title">{trans(`Log in as instructor`)}</h4>
                        </div>
                        <Formik
                                        ...
                                        <div className="row">
                                            ...
                                            <FormGroup className="col-sm-12 mb-3">
                                                <div className="flex-between align-items-start">
                                                    ...
                                                    <Link href={'/instructor/password-reset-request'} className="forgot-password">{trans(`Forgot Your Password`)}?</Link>
                                                </div>
                                                <div className="position-relative">
                                                    ...
                                                    />
                                                    <span className={`password-show-hide toggle-password  ${showPassword ? 'fas fa-eye' : 'fas fa-eye-slash'}`}

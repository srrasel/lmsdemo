...
class GeneralSettingController extends Controller
{
    ...
    public function systemConfigurationSubmit(Request $request)
    {
        ...
        $general->instructor_kv = $request->instructor_kv ? Status::ENABLE : Status::DISABLE;
        ...
        $general->instructor_registration = $request->instructor_registration ? Status::ENABLE : Status::DISABLE;

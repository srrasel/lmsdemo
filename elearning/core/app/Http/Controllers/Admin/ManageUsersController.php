...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $enrolledCourse  = CoursePurchased::where('payment_status' , Status::PAYMENT_SUCCESS)->where('user_id', auth()->id())->count();
        

        $totalWithdrawals = Withdrawal::where('user_id',$user->id)->approved()->sum('amount');
        $totalTransaction = Transaction::where('user_id',$user->id)->count();
        $countries = json_decode(file_get_contents(resource_path('views/partials/country.json')));
        $enrolledCourse  = CoursePurchased::where('payment_status' , Status::PAYMENT_SUCCESS)->where('user_id', $user->id)->count();
        return view('admin.users.detail', compact('pageTitle', 'user','totalDeposit','enrolledCourse','totalTransaction','countries','enrolledCourse'));
    }

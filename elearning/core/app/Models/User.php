...
class User extends Authenticatable
{
    ...
    public function purchases(){
        return $this->hasMany(CoursePurchased::class);
    }

    public function quizsubmit(){
        return $this->hasMany(QuizSubmit::class);
    }
    ...
    public function getCertificates(){
        return $this->hasOne(GetCertificateUser::class);
    }
    ...
    public function getProfilePathAttribute(){
        return asset(getFilePath('userProfile'));
    }

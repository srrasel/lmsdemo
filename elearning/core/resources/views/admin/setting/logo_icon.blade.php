                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-xl-5 col-sm-6">
                            ...
                            <div class="form-group col-xl-5 col-sm-6">
                                ...
                                <x-image-uploader name="logo_dark" :imagePath="siteLogo('dark') . '?' . time()" :size="false" class="w-100" id="uploadDarkLogo" :required="false"  />
                            </div>

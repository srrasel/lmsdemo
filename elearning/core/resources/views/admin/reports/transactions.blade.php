                        ...
                        <div class="d-flex flex-wrap gap-4">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <select name="user_type" class="form-control select2" data-minimum-results-for-search="-1">
                                    ...
                                    <option value="user" @selected(request()->user_type == 'user')>@lang('User')</option>
                                    <option value="instructor" @selected(request()->user_type == 'instructor')>@lang('Instructor')</option>
                                </select>
                            </div>
                            <div class="flex-grow-1">
                                ...
                                @forelse($transactions as $trx)
                                    <tr>
                                        <td>
                                            ...
                                            @else
                                                <span class="fw-bold">{{ $trx->instructor?->fullname }}</span>
                                                <br>
                                                <span class="small"> <a
                                                        href="{{ appendQuery('search', $trx->instructor?->username) }}"><span>@</span>{{ $trx->instructor?->username }}</a>
                                                </span>
                                            @endif
                                        </td>

...
@section('panel')
    ...
    @push('breadcrumb-plugins')
        ...
        @elseif(@$instructor)
            <a href="{{ route('admin.instructors.notification.single', $instructor->id) }}"
                class="btn btn-outline--primary btn-sm"><i class="las la-paper-plane"></i> @lang('Send Notification')</a>
        @else
